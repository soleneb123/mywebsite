...
![Expanding Window Time Series Cross Validation.](images/crossvalidation.png){fig-align="center" width="350"} All preprocessing steps (scaling, transformations, feature selection) were embedded inside a scikit-learn Pipeline, ensuring that transformations are learned exclusively from the training portion of each fold. This design fully prevents data leakage and guarantees a fair evaluation.
